...
SECRET_KEY = 'django-insecure-#e64%r%7s^55nn02+2%*)h($7$u82f*u0!u2z^w_je3ezu77nq'
...
INSTALLED_APPS = [
    ...
    'django_filters',  # D4 подключаем фильтр

    'fpages',  # D1
    'news',  # D2 подключаем приложение
...
MIDDLEWARE = [
    ...
    'django.contrib.flatpages.middleware.FlatpageFallbackMiddleware',  # D1
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # D1 указываем место нахождения папки с шаблонами
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
TIME_ZONE = 'UTC'  # установить свой часовой пояс
